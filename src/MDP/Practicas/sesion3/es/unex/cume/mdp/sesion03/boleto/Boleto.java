...
public abstract class Boleto implements Comparable{
    ...
    public int aciertos(Boleto b) {
    	...
    	copia.retainAll(b.numeros); //Interseccion
    	return copia.size();
    }
    ...
    public Boleto(int identificador, Date f, int cant, int maxN, int maxC) {
    ...
    public Boleto(int identificador, Date f) {
        this.identificador = identificador;
        fecha = f;
        jugado = false;
        this.numeros = new ArrayList<>();
    ...
    public int compareTo (Object o){
        Boleto aux = (Boleto) o;
        return this.identificador-aux.identificador;
    }
}
