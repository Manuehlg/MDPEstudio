package MDP.Practicas.sesion4.es.unex.cume.mdp.sesion04;
...
import MDP.Practicas.sesion4.es.unex.cume.mdp.sesion04.onlae.*;
...
public class MainBoleto4 {
    public static void main(String[] args)  {
        ...
        Boleto b = new Gordo(1, LocalDate.now());
        ...
        for (int i = 0; i < 10; i++) {
            ...
            LocalDate fechaAleatoria = LocalDate.of(2025, mes, dia);
        ...
        Boleto ganador = new Gordo(1, LocalDate.now());
